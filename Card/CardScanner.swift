...
public class CardScanner: UIViewController {
    ...
    public var hintTopText = "Центрируйте карту, пока поля не будут распознаны"
    public var hintBottomText = "Коснитесь распознанного значения, чтобы удалить его, и повторите попытку."
    public var buttonConfirmTitle = "Подтверждать"
    public var buttonConfirmBackgroundColor: UIColor = .green
    public var viewTitle = "Сканер карт"
